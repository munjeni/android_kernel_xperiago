/* drivers/video/mcde/display-r61408_dsi_samsung_lms347tf01.c
 *
 * Copyright (C) 2012 Sony Ericsson Mobile Communications AB.
 * Copyright (C) 2012 Sony Mobile Communications AB.
 *
 * Sony Renesas 61408 driver for samsung panel
 *
 * Author: Pan Yantao <yantao2.pan@sonymobile.com>
 *
...
static const u32 ddb_0425_no_rev[] = {
	0x00002504,
	0x0000FF00,
	DDB_END
};

static const u32 ddb_mask_0425_no_rev[] = {
	0x0000FFFF,
	0x0000FF00,
	DDB_END
};
...
const struct panel r61408_dsi_samsung_0425_no_rev = {
	.name = "Samsung LMS347TF01 MIPI/DSI 0425 no rev",
	.ddb = ddb_0425_no_rev,
	.ddb_mask = ddb_mask_0425_no_rev,
	.id_regs = id_regs,
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("MCDE DSI Samsung LMS347TF01 display driver");
