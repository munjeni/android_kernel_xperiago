...
#define AX_MODULE_NAME "axperiago_ondemandax"
...
static
//#endif
struct cpufreq_governor cpufreq_gov_ondemandax = {
       .name                   = "ondemandAX",
...
static int __init cpufreq_gov_dbs_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_ondemandax);
}

static void __exit cpufreq_gov_dbs_exit(void)
{
	cpufreq_unregister_governor(&cpufreq_gov_ondemandax);
}
