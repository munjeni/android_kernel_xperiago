...
static pin_cfg_t mop500_pins_default[] = {
	...
	GPIO143_GPIO		|	PIN_INPUT_PULLDOWN,
	GPIO144_GPIO		|	PIN_INPUT_PULLDOWN,
	GPIO145_GPIO		|	PIN_INPUT_PULLDOWN,
	GPIO146_GPIO		|	PIN_INPUT_PULLDOWN,
